    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, null=True, upload_to='readbooks/files/', verbose_name='Файл для скачивания')),
                ('image', models.ImageField(blank=True, null=True, upload_to='readbooks/images/', verbose_name='Изображение')),
                ('book', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='news.bookarrival')),
